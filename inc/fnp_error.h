...
#define FNP_ERR_CC_ALGO -15 // 不支持的拥塞控制算法
...
#define FNP_ERR_EPOLL_ADD -550  // epoll_ctl add 失败
#define FNP_ERR_EPOLL_WAIT -551 // epoll_wait 调用失败

// DPDK相关
#define FNP_ERR_RTE_EAL_INIT -100
#define FNP_ERR_MALLOC -111
