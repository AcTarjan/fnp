...
static void picoquic_report_pacing_update(picoquic_pacing_t* pacing, picoquic_path_t* path_x)
{
    ...
    //     {
    //         (void)cnx->callback_fn(cnx, pacing->rate, NULL, 0, picoquic_callback_pacing_changed, cnx->callback_ctx,
    //                                NULL);
    ...
    //     {
    //         (void)cnx->callback_fn(cnx, path_x->unique_path_id, NULL, 0, picoquic_callback_path_quality_changed,
    //                                cnx->callback_ctx, path_x->app_path_ctx);
